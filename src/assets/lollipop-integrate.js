(function() {
   ...
   var Lollipop = function() {
      var instance = {
         ...
         setNewImageUrl: function(url) {_lollipop.params.newImage_url = url;},
         ...
         save: function(data,extension) {_lollipop.params.onSave(data,extension);},
         image: undefined
      }
      return instance;
   }
   var _lollipop = {
      ...
      integrateFrame: function(finalImage_url) {
         ...
         frame.onload = function() {
            ...
            frame.contentWindow.$('.setting').perfectScrollbar();
            frame.contentWindow.$('.theme').perfectScrollbar();
            frame.contentWindow.image.src = finalImage_url;
            frame.contentWindow.image.onload = function () {
               frame.contentWindow.Render.initCanvas();
            }
            if (_lollipop.params.share_icon === true)
               frame.contentWindow.document.querySelector("#share-btn").style.display = "block";
      ...
      getFinalImage: function(url) {
         ...
         var request = _lollipop.ajax('getImage.php', 'url=' + _lollipop.absoluteUrl(url));
